...
public class ConstantsExamples {
    ...
    public static final double[] VM_MIPS = new double[]{4660, 4660, 4660,4660};
    //public static final int[] VM_PES = new int[]{10, 10, 10, 10};
    //public static final float[] VM_RAM = new float[] {(float)1024, (float) 1024, (float) 1024, (float) 1024};//**MB*
    public static final int[] VM_PES = new int[]{1, 1, 1, 1};
    public static final float[] VM_RAM = new float[] {(float)128, (float) 128, (float) 128, (float) 128};//**MB*    
    ...
    public static final int[] CONTAINER_MIPS = new int[]{4658, 4658, 4658};
    ...
    public static final int NUMBER_HOSTS = 300;
    public static final int NUMBER_VMS = 400;
    public static final int NUMBER_CLOUDLETS = 400;
    //eunsook
    public static final int NUMBER_FRAMEWORK=400;
