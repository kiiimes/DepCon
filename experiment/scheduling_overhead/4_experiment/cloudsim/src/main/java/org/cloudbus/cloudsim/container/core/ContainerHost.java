...
public class ContainerHost {
    ...
    public ContainerHost(
        ...
        setPeList(peList);
        setFailed(false);
        setAvailableBw(containerVmBwProvisioner.getBw());
        setAvailableCpu(peList.size());
        setAvailableMem(containerVmRamProvisioner.getRam());
    ...
    public boolean containerVmCreate(ContainerVm vm) {
        ...
        setAvailableCpu(getAvailableCpu()-vm.getNumberOfPes());
        setAvailableMem(getAvailableMem()-vm.getRam());
